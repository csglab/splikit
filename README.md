...
- R libraries: [RcppArmadillo](https://cran.r-project.org/web/packages/RcppArmadillo/index.html), [RcppEigen](https://cran.r-project.org/web/packages/RcppEigen/index.html), [Rcpp](https://cran.r-project.org/web/packages/Rcpp/index.html), [Matrix](https://cran.r-project.org/web/packages/Matrix/index.html), [data.table](https://cran.r-project.org/web/packages/data.table/index.html),  [countsplit](https://cran.r-project.org/web/packages/countsplit/index.html)
